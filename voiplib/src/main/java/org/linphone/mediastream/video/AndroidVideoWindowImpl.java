...
public class AndroidVideoWindowImpl {
   ...
   public Surface getSurface() {
      if (this.useGLrendering) {
         Log.i("View class does not match Video display filter used (you must use a non-GL View)");
      }
   ...
   public void setOpenGLESDisplay(long ptr) {
      if (!this.useGLrendering) {
         Log.i("View class does not match Video display filter used (you must use a GL View)");
      }

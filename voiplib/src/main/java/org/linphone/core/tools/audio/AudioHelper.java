...
public class AudioHelper implements OnAudioFocusChangeListener {
   ...
   public void startAudioForEchoTestOrCalibration() {
      ...
      try {
         ...
         Log.i("[Audio Helper] Couldn't increase volume: ", var3);
      }
   ...
   public void stopAudioForEchoTestOrCalibration() {
      try {
         ...
         Log.i("[Audio Helper] Couldn't restore volume: ", var2);
      }
            ...
            if (defaultRingtoneUri == null) {
               ...
               try {
                  ...
                  if (this.mRingtone != null) {
                     ...
                     Log.i("[Audio Helper] Couldn't retrieve Ringtone object from manager!");
                  }
               } catch (Exception var8) {
                  Log.i("[Audio Helper] Failed to play ringtone [", defaultRingtoneUri, "] : ", var8);
               }
            }
         }
   ...
   public void releaseRingingAudioFocus() {
      if (this.mRingingRequest != null) {
         ...
         if (result == 1) {
            ...
            Log.i("[Audio Helper] Ringing audio focus abandon request failed");
         }
      }
   ...
   public void releaseCallAudioFocus() {
      if (this.mCallRequest != null) {
         ...
         if (result == 1) {
            ...
            Log.i("[Audio Helper] Call audio focus abandon request failed");
         }
   ...
   public void restorePreviousAudioRoute() {
      if (!CoreManager.isReady()) {
         Log.i("[Audio Helper] CoreManager has been destroyed already!");
      } else {
         ...
         if (core != null) {
            ...
            Log.i("[Audio Helper] CoreManager instance found but Core is null!");
         }
   ...
   public void routeAudioToSpeaker() {
      if (!CoreManager.isReady()) {
         ...
         if (core != null) {
            ...
            Log.i("[Audio Helper] Couldn't find speaker audio device");
         } else {
            Log.i("[Audio Helper] CoreManager instance found but Core is null!");
         }
   ...
   private void playSoundUsingMediaPlayer(Context context, AudioAttributes audioAttrs, String ringtone) {
      ...
      try {
         ...
         Log.i("[Audio Helper] Cannot play ringtone [", ringtone, "]: ", var5);
      } catch (SecurityException var6) {
         Log.i("[Audio Helper] Cannot play ringtone [", ringtone, "]: ", var6);
      }

...
public class FirebaseMessaging extends FirebaseMessagingService {
   ...
   private void onPushReceived(RemoteMessage remoteMessage) {
      if (!CoreManager.isReady()) {
         ...
         org.linphone.core.tools.Log.i("[Push Notification] Received: " + this.remoteMessageToString(remoteMessage));
         if (CoreManager.instance() != null) {
            ...
            if (core != null) {
               ...
               org.linphone.core.tools.Log.i("[Push Notification] Notifying Core we have received a push for Call-ID [" + callId + "]");
